...
// Ajv schema to validate the request body
// Used Copilot to resolve an error where the 'additional properties' and 'required'
// properties were misplaced within the Ajv Schema.
